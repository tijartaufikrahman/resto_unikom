...
$query = "SELECT 
    ...
    oli.food_id,
    oli.quantity,
    oli.price AS order_list_item_price,
    oli.note AS order_list_item_note,
    oli.status AS order_list_item_status,
    oli.img AS order_list_item_img,
